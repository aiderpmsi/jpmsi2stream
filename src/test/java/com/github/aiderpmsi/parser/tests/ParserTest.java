...
import com.github.aiderpmsi.pims.parser.utils.Utils;
...
public class ParserTest {
    ...
    @Test
    public void testParserFromWriter() throws Exception {
    	String rsf =
    			"78001731400160070101201331102013056024006430000000020988560\n"
    			+ "A7800173140                   22236119935340468000302130265110  41070211193610103201331032013003115550031155500026293000262930000000000000000000000000031155510         \n"
    			+ "B7800173140                   236119935340468000302130265197960203201302032013D11  001400100 0000000252680002526810000025268000252680000000000000025268PAI\n"
    	...
    	LinkedList<IPmsiLine> pmsilines = new LinkedList<>();
		
    	LinkedList<String> errors = new LinkedList<>();

    	ArrayList<Utils.LineHandler> lineHandlers = new ArrayList<>();
    	lineHandlers.add((pmsiLine) -> pmsilines.add(pmsiLine));
    	
    	SimpleParser parser = pf.newParser("rsfheader",
    			lineHandlers,
    			(msg, line) -> errors.add(msg));
    	...
    	Assert.assertEquals(34, pmsilines.size());
    }
