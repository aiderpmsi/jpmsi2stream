...
public class PmsiRsfa extends PmsiLineType {
	...
	public PmsiRsfa() {
		...
		PmsiInternalElement MyIdMain =new PmsiInternalElement("rsfaid", PmsiStandardDbTypeEnum.BIGSERIAL, 0);
		MyIdMain.setValue("nextval('rsfa_rsfaid_seq')");
		addChamp(MyIdMain);
		PmsiIndexElement MyIdmainIndex = new PmsiIndexElement("RSFA_rsfaid_pidx", PmsiIndexElement.INDEX_PK);
		...
		addChamp(MyIdHeader);
		PmsiFkElement MyIdHeaderFK = new PmsiFkElement("RSFA_rsfheaderid_fk", "RSFHeader", "DEFERRABLE INITIALLY DEFERRED");
		...
		PmsiIndexElement MyFinessIndex = new PmsiIndexElement("RSFA_FINESS_idx", PmsiIndexElement.INDEX_SIMPLE);
		...
		PmsiIndexElement MyNumRSSIndex = new PmsiIndexElement("RSFA_NumRSS_idx", PmsiIndexElement.INDEX_SIMPLE);
		...
		PmsiIndexElement MyNumFactureIndex = new PmsiIndexElement("RSFA_NumFacture_idx", PmsiIndexElement.INDEX_SIMPLE);
		MyNumFactureIndex.addIndex("NumFacture");
		addChamp(MyNumFactureIndex);
		
		PmsiIndexElement MyUniqueNumFactureIndex = new PmsiIndexElement("RSFA_rsfheaderid_NumFacture_idx", PmsiIndexElement.INDEX_UNIQUE);
		...
		PmsiIndexElement MyDateEntreeIndex = new PmsiIndexElement("RSFA_DateEntree_idx", PmsiIndexElement.INDEX_SIMPLE);
		...
		PmsiIndexElement MyDateSortieIndex = new PmsiIndexElement("RSFA_DateSortie_idx", PmsiIndexElement.INDEX_SIMPLE);
