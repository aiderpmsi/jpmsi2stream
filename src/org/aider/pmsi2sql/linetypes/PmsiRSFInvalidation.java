...
public class PmsiRSFInvalidation extends pmsilinetype {

	/**
	 * Constructeur
	 */
	public PmsiRSFInvalidation() {
		super("RSFA");
		...
		addChamp(MyIdHeader);
		pmsifkdbtype MyIdHeaderFK = new pmsifkdbtype("RSFA_rsfheaderid_fk", "RSFHeader");
